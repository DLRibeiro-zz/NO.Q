package cadastroPrato.domain.restaurante.persistidas;

import cadastroPrato.domain.restaurante.CNPJ;
import cadastroPrato.domain.restaurante.PratoComposto;
import cadastroPrato.domain.restaurante.PratoSimples;
import cadastroPrato.domain.restaurante.Preco;
...
@JsonSubTypes({
    ...
    @Type(value = PratoComposto.class, name = "compsto")
})
